...
public class FunctionsSystemTest {
    ...
    @DisplayName("Test Functions' System with trigonometry Mocks")
    @ParameterizedTest
    @CsvSource(value = {
            "0.98, 0.0",
            "1,    0.0",
    ...
    public void integrateTestLn(double x, double expectedResult) {
        Cos cos = Mockito.spy(Cos.class);
        Sin sin = Mockito.spy(Sin.class);
        Csc csc = Mockito.spy(Csc.class);
        Sec sec = Mockito.spy(Sec.class);
        ...
        FunctionsSystem system = new FunctionsSystem(cos, sin, cot, tg, csc, sec, new Ln(), new Log2(), new Log3(), new Log5());

        assertEquals(expectedResult, system.calculate(x, 0.000001), DELTA);
        assertEquals(Double.NaN, system.calculate(0, 0.000001));
    }

    @DisplayName("Test Functions' System with only Cos Mock")
    @ParameterizedTest
    @CsvSource(value = {
            "0.98, 0.0",
            "1,    0.0",
    ...
    public void integrateTestTrig(double x, double expectedResult) {
        Cos cos = Mockito.spy(Cos.class);
        ...
        FunctionsSystem system = new FunctionsSystem(cos, new Sin(), new Cot(cos), new Tg(cos), new Csc(), new Sec(), new Ln(), new Log2(), new Log3(), new Log5());
